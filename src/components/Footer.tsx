    ...
    <footer className="bg-primary-900 text-white">
      ...
      <div className="container-custom py-16">
        <div className="flex flex-col items-center text-center">
          {/* Brand */}
          <h3 className="font-serif text-2xl text-white mb-6 tracking-wider">
            {brandName}
          </h3>
          ...
          <div className="flex items-center gap-4">
            <a
              href="#"
              className="w-10 h-10 flex items-center justify-center border border-white/20 text-white/60 hover:border-accent-500 hover:text-accent-500 transition-all duration-300"
